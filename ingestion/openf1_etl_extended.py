...
MAX_RETRIES = 3  # Wiederholungen bei 429


def fetch_by_year(endpoint: str) -> pd.DataFrame:
    """Endpunkte, die year direkt unterstützen (sessions, meetings)."""
...
def main():
    ...
    # ── 1. Sessions (year-Filter funktioniert hier) ──────────────────────────
    print("Lade Sessions...")
    ...
    # Nur abgeschlossene Sessions (date_end in der Vergangenheit)
    ...
    # ── 4 & 5. Position → Starting Grid + Session Results ───────────────────
    print("\nLade Position-Daten...")
